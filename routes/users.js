  ...
  User.checkEmail(req.body.email,(err,user) => {
    ...
    if (user.length == 0 ) { 
      ...
      bcrypt.hash(password,  10, function(err, hash){
        ...
        User.create(req.body.nom, req.body.prenom, req.body.gender, birthdate, req.body.country, req.body.address, req.body.province,req.body.city, req.body.zip, req.body.citizenshipStatus, req.body.phone1, req.body.phone2, req.body.relationshipParent, req.body.nameParent, req.body.phoneParent, deliveryDateID,expirationDateID, hash, req.body.email, req.body.roleUser, req.body.associationId, req.body.invitationId, (err, user) => {
          if (err) {
            console.log('error: ', err);
            res.status(200).send(err);
            return;
